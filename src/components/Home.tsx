...
function Home() {
  ...
  return (
    <section
      id="home"
      className="relative w-full h-full pt-16 pb-2 lg:pt-44 lg:pb-20 bg-secondary scroll-mt-24"
    >
      <article className="lg:w-2/3 w-[90%] mx-auto lg:items-center lg:justify-between lg:flex">
        <div>
          <div className="lg:text-[2.7rem] text-3xl font-semibold leading-relaxed text-primary">
            <p>
              ...
              <span className="text-black/80">
                에<br className="block md:hidden" /> 따라 달라집니다.
              </span>
            </p>
            <p className="mt-10">
